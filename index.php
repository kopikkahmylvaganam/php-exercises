...
<form action= "insert-student-data.php" method="post">
  <div class="form-group" style="margin-bottom:20px">
    ...
    <input type="text" class="form-control" name="student_id" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=" Enter Student ID">
  </div>
  ...
  <div class="form-group" style="margin-bottom:20px">
    ...
    <input type="text" class="form-control" name="dob" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Date of birth">
  </div>
